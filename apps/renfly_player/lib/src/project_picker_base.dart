...
/// (desktop/mobile folder paths, or .fly/.fly.zip file paths). Web uploads
/// have no durable path, so it is null there and the project must be re-picked
/// on a future launch.
...
abstract interface class RenPyProjectPicker {
  ...
  /// Prompts the user to choose a .fly or .fly.zip file.
  Future<PickedProject?> pickFile();
